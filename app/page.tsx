...
function HomePage() {
  ...
  return (
    <div className='w-full flex items-center justify-center relative'>
      <div className='fixed -z-50 blur-md bg-black top-0 left-0 w-full h-screen' style={{backgroundImage:"url(https://esquirescoffee.co.uk/wp-content/uploads/2021/03/nafinia-putra-Kwdp-0pok-I-unsplash.jpg)"}}>
        <div className='bg-black/30 w-full h-full'></div>
      </div>
      <div className='w-full overflow-x-hidden max-w-3xl shadow-xl' style={{backgroundColor:"#f2e9dc"}} >
